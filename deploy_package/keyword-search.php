...
<html>
<head>
<title>Keyword Search | Shaadi Partner</title>
...
<div class="container">
    <div class="search-tabs">
        ...
        <a href="keyword-search.php" class="search-tab active">Keyword Search</a>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="keyword-help">
                        <p style="margin: 0 0 10px 0;"><strong>Search by Keywords:</strong></p>
                        <p style="margin: 0; color: #666;">You can search profiles using keywords like profession, religion, city, caste, education, etc.</p>
                        <p style="margin: 10px 0 0 0;">
                            <span class="keyword-examples">keywords eg:</span> 
                            <span style="color: #667eea;">brahmin</span>, 
                            <span style="color: #667eea;">engineer</span>, 
                            <span style="color: #667eea;">delhi</span>, 
                            <span style="color: #667eea;">religious</span>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="keyword" class="form-control" placeholder="Enter keywords to search profiles..." style="padding: 15px; font-size: 16px;">
                    </div>
                </div>
            </div>
...
<script>
$('#keyword-search-form').on('submit', function(e) {
    e.preventDefault();
    
    const formData = {};
    $('#keyword-search-form').serializeArray().forEach(item => {
        if (item.value) {
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.success) {
                ...
                $('#search-results').html('<div class="alert alert-warning">No profiles found. Try different keywords.</div>');
            }
        },
        error: function() {
...
function displayResults(results, count) {
    ...
    if (count === 0) {
        container.html('<div class="alert alert-info text-center"><h4>No profiles found</h4><p>Try different keywords</p></div>');
        return;
    }
